...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col items-center gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-40 glass-panel rounded-2xl py-6 px-3 border border-border bg-panel/70">
      ...
      {items.map(({ href, icon: Icon }) => (
        <a
          ...
          className={`h-10 w-10 flex items-center justify-center rounded-xl transition-all ${active === href
              ? "bg-blue-600/30 text-cyan-300 border border-blue-500/60 shadow-[0_0_15px_rgba(56,189,248,0.3)]"
